...
class LoginGoogleActivity : AppCompatActivity() {
    ...
    private fun mockData(){
        ...
        attractionViewModel.insert(Attraction(9,"Jungle Treking", 1564486657,1564496100,25,25,"Get lost in the green","-8.409518", "115.188919", "Bali, Indonesia", "(406) 703-6279",1,1564485950,"Airplane"))

        attractionViewModel.insert(Attraction(10,"Swimming with Sharks", 1572739200,1572748451,25,25,"Don't be eaten","-8.409518", "115.188919", "Bali, Indonesia", "(403) 214-5135",1,1572738653,"Airplane"))
        attractionViewModel.insert(Attraction(11,"Live Music", 1564486657,1564496100,25,25,"Come for a famous star","36.114647", "-115.172813", "Washington", "(670) 480-9095",2,1564485950,"Walking"))
        ...
        attractionViewModel.insert(Attraction(2,"Casino Gambling", 1572739200,1572748451,25,25,"Have fun tossing $ away","36.114647", "-115.172813", "Washington", "(849) 729-8349",2,1572738653,"Walking"))
        ...
        attractionViewModel.insert(Attraction(5,"Tiger Petting", 1572739200,1572748451,25,25,"Which is the furriest?","13.736717", "100.523186", "Thailand", "(321) 633-3550",5,1572738653,"Tuk-tuk"))
        ...
        attractionViewModel.insert(Attraction(6,"Soldier Training", 1572739200,1572748451,25,25,"Become a soldier for a day","36.862499", "10.195556", "Tunisia, Africa", "(558) 353-3320",6,1572738653,"Ship"))
        ...
        attractionViewModel.insert(Attraction(7,"Hammock Massage", 1572739200,1572748451,25,25,"Get massaged by the beach on a hammock","7.946527", "-1.023194", "Ghana, Africa", "(672) 909-9102",1,1572738653,   "Airplane"))
        ...
        attractionViewModel.insert(Attraction(8,"Snowshoeing", 1572739200,1572748451,25,25,"Hike over the vast snowy desert","-75.2509766", "-0.071389", "Antarctica", "(402) 986-9213",6,1572738653,"Ship"))
        ...
        attractionViewModel.insert(Attraction(9,"Paragliding", 1572739200,1572748451,25,25,"Fly through the clouds","48", "74", "Patagonia, Chile", "(813) 287-9376",3,1572738653,"Train"))
        ...
        attractionViewModel.insert(Attraction(10,"Outdoor Basketball Game", 1572739200,1572748451,25,25,"Watch amazing feats of skill","40.650002", "-73.949997", "Brooklyn, New York", "(872) 886-7323",7,1572738653,"Car"))
